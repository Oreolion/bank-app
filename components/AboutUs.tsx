...
const AboutUs = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="section-padding gradient-radial mt-4">
      <div className="cu-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div
            ...
            className="opacity-0 translate-x-[50px] transition-all duration-1000 ease-out"
          >
            <span className="text-2xl inline-block py-1 px-3 rounded-full bg-cu-blue bg-opacity-10 text-cu-blue font-medium mb-4">
              About Us
            </span>
            ...
            <p className="text-cu-dark-gray mb-6">
              Founded in 1979, AFFFCO has been serving our community with
              dedication and integrity for over four decades. As a member-owned
              financial cooperative, we put people before profits and are
              committed to your financial well-being.
            </p>

            <p className="text-cu-dark-gray mb-6">
              Our mission is to provide accessible financial services and
              education to help our members achieve their goals and build a
              stronger community through cooperative principles.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              ...
              <div>
                <h4 className="text-2xl font-bold text-cu-blue mb-2">
                  25,000+
                </h4>
